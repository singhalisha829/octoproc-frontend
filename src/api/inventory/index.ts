...
export const getLegders = async ({ pageSize = 100, pageNum = 1, enterprise_client_id }: { pageSize: number, pageNum: number, enterprise_client_id: number | null }): Promise<InventoryRecord[]> => {
